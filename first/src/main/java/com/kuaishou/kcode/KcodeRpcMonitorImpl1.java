 ...
 * 实际提交时请维持包名和类名不变
 */
public class KcodeRpcMonitorImpl1 implements KcodeRpcMonitor {
    private static final ThreadPoolExecutor threadPool = new ThreadPoolExecutor(1, 1, 60, TimeUnit.SECONDS, new LinkedBlockingQueue<>());
    ...
    public List<String> checkPair(String caller, String responder, String time) {
        //虽然概率非常低，但是仍然存在不同的caller reponder time的hash值相同
    ...
    //1313 1024+256+32+1 101,0010,0001 1313是一个比较大的可以利用位运算的质数
    ...
    public String checkResponder(String responder, String start, String end) {
        Integer hash = hash(responder, start, end);//甚至可以缓存hash值
