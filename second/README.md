...
## 题目内容
- 实现一个报警检查程序，输入一组报警规则和一个监,控文件路径，触发器负责分析监控数据并返回所有的触发的报警的数据。
...
其实规则3中，**下游**这个表述是不正确的，即当存在调用链B->C C->D，且C->D的P99>350ms时，认为C->D也符合是不正确的。
规则2、3中的ALL，只能单纯地当作是通配符。

**报警阈值计算是以主被调ip对聚合，聚合时间粒度为1分钟**，要特别注意这个**主被调ip对**。
...
serviceA,172.17.60.2,serviceB,172.17.60.3,true,50,1592454900000「2020-06-18 12:35」
...
聚合结果
```$xslt
serviceA,172.17.60.2,serviceB,172.17.60.3,1.0,30「2020-06-18 12:33」
serviceA,172.17.60.2,serviceB,172.17.60.3,1.0,50「2020-06-18 12:35」

serviceZ,172.17.60.8,serviceA,172.17.60.2,1.0,420「2020-06-18 12:33」

serviceZ,172.17.60.8,serviceC,172.17.60.4,1.0,120「2020-06-18 12:33」

serviceB,172.17.60.3,serviceC,172.17.60.4,1.0,380「2020-06-18 12:33」
serviceB,172.17.60.3,serviceC,172.17.60.4,1.0,395「2020-06-18 12:34」
serviceB,172.17.60.3,serviceC,172.17.60.4,1.0,404,「2020-06-18 12:35」

serviceB,172.17.60.3,serviceD,172.17.60.5,1.0,120「2020-06-18 12:33」
serviceB,172.17.60.3,serviceD,172.17.60.5,1.0,430「2020-06-18 12:34」

serviceC,172.17.60.4,serviceD,172.17.60.5,1.0,241「2020-06-18 12:33」
serviceC,172.17.60.4,serviceD,172.17.60.5,1.0,345「2020-06-18 12:34」
serviceC,172.17.60.4,serviceD,172.17.60.5,1.0,350「2020-06-18 12:35」

serviceD,172.17.60.5,serviceE,172.17.60.4,1.0,102「2020-06-18 12:35」
serviceE,172.17.60.4,serviceF,172.17.60.4,1.0,110「2020-06-18 12:35」
serviceD,172.17.60.5,serviceF,172.17.60.4,1.0,120「2020-06-18 12:35」
```
...
规则编号： 同上描述
报警触发时间：真正满足报警规则的时间点，例如：规则2，12:33开始p99已大于300ms，但是持续时间不够，那么报警触发时间应该是12:34
 ...
 **只有在给出的数据中只要有过调用关系都属于有调用关系，和具体的分钟数无关**
 ...
 ![image](../kcodealertanalysis_65d406ef46fe2e5f7114c414cfcc4acf/demo.png)
